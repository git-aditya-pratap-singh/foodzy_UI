...
import { FaLock,FaUser,FaFingerprint } from "react-icons/fa";
...
const Signup = ()=>{
    ...
    return(
        <>
        <section className="flex flex-col lg:flex-row gap-y-18 lg:h-screen bg-white">
            ...
            <div className="basis-1/2 flex justify-center items-center bg-white py-8">
                ...
                <div className="w-80 lg:w-96 p-2 flex flex-col space-y-10 ">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-y-8" autoComplete="on">
                       ...
                       <button className="p-2 w-full outline-none fonts text-white bg-red-400 rounded-md shadow-sm">SIGNUP</button>
