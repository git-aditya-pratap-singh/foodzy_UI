...
const Dashboard = ()=>{
    ...
    const ForwardScoll = ()=> scrollData.scrollLeft += 500;
    const BackwardScoll = ()=> scrollData.scrollLeft -= 500;
    ...
    return(
        ...
        <span className="flex flex-col justify-start gap-y-3 px-5 lg:px-20 pt-10 ">
            <h1 className="font text-xl lg:text-2xl font-extrabold ">Top Restaurant Chains in Bengaluru</h1>
