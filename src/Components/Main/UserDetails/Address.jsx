...
const Address = ()=>{
    ...
    return(
        ...
        <div className="flex flex-row space-x-2 lg:space-x-5 p-2 lg:p-3 rounded-md border shadow items-center lg:w-1/3">

            <span className="text-[1.3rem] p-3 text-[#fc036f]"><FaHome/></span>
            ...
            <span className="flex flex-col space-y-2 py-3">
                ...
                <div className="flex space-x-6 fonts  text-[#fc036f] select-none">
                    ...
                    <span className="hover:text-gray-700 cursor-pointer">DELETE</span>    
                </div>
